...
public class AdocaoFragment extends Fragment implements Download_data.download_complete {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        minhaview = inflater.inflate(R.layout.fragment_adocao, container, false);
        ...
        download_data.download_data_from_link("https://buscapet.000webhostapp.com/animais_listagem.php?table=adocao");
    ...
    public void get_data(String data)
    {
        try {
            ...
            for (int i = 0 ; i < data_array.length() ; i++)
            {
                ...
                add.animal_especie = obj.getString("especie");
